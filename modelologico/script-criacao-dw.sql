...
ALTER TABLE Fato_005 ADD CONSTRAINT fato_003_fato_005_fk
FOREIGN KEY (Cod_Fabrica, Cod_Tempo)
REFERENCES Fato_003 (Cod_Fabrica, Cod_Tempo)
ON DELETE NO ACTION
ON UPDATE NO ACTION;dmpresidencia